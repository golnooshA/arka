...
class _OneProductState extends State<OneProduct> {
  ...
  Widget build(BuildContext context) {
                          ...
                          child: Column(
                            children: [
                              ...
                              InkWrapper(
                                ...
                                highlightColor: DesignConfig.highlightColor,
                                splashColor: DesignConfig.splashColor,
                                child: Icon(Icons.keyboard_arrow_down_outlined, color: DesignConfig.bookmarkColor, size: 30),
                                onTap: () async {
                                  await showModalBottomSheet<String>(context: context,
                                      isDismissible: false,
                                        ...
                                        return Column(
                                          children: [
                                            Container(
                                              ...
                                              child: IconButton(
                                                  icon: Icon(Icons.keyboard_arrow_down_outlined,
                                                      color: DesignConfig.appBarOptionsColor,size: 40),
                                                  onPressed: () {
                                            ...
                                            ListTile(
                                              ...
                                              subtitle: Padding(
                                                padding: EdgeInsets.only(top: 8, bottom: 12),
                                                // empty            red  DesignConfig.emptyProductColor
                                                // half full        orange   DesignConfig.halfFullProductColor
                                                // full        blue   DesignConfig.fullProductColor
    ...
    return CachedNetworkImage(
      imageUrl:  'https://www.azingar.ir/wp-content/uploads/2019/12/Walnut-Wood-Seamless-Background-Texture-6.jpg',
      width: double.infinity,
      height: MediaQuery.of(context).size.height,
      fit: BoxFit.cover,
